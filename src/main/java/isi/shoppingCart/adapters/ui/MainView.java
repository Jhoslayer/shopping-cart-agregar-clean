...
public class MainView {
    ...
    private VBox createCartPanel() {
        ...
        emptyCartButton.setOnAction(event -> showMessage("Función no implementada aún"));
        ...
        for (CartItem item : items) {
            ...
            subtractButton.setOnAction(event -> {
                OperationResult result =
                        shoppingCartApp.decreaseQuantity(item.getProduct().getId());
            ...
            increaseButton.setOnAction(event -> {
                OperationResult result =
                        shoppingCartApp.increaseQuantity(item.getProduct().getId());
            ...
            deleteButton.setOnAction(event -> {
                OperationResult result =
                        shoppingCartApp.removeProductFromCart(item.getProduct().getId());
